      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-1 gap-12 items-center">
          ...
          <div className="absolute inset-0 pointer-events-none">
            ...
            <div className="absolute top-32 right-16 w-40 h-40 rounded-full bg-white/20 backdrop-blur-sm border border-white/30 shadow-glow flex items-center justify-center animate-[float-bubble-2_15s_ease-in-out_infinite_2s]">
              <img 
            ...
            <div className="absolute bottom-40 left-1/4 w-40 h-40 rounded-full bg-white/20 backdrop-blur-sm border border-white/30 shadow-glow flex items-center justify-center animate-[float-bubble-3_10s_ease-in-out_infinite_1s]">
              <img 
            ...
            <div className="absolute top-1/3 right-1/4 w-40 h-40 rounded-full bg-white/20 backdrop-blur-sm border border-white/30 shadow-glow flex items-center justify-center animate-[float-bubble-1_14s_ease-in-out_infinite_3s]">
              <img 
            ...
            <div className="absolute bottom-1/3 right-20 w-40 h-40 rounded-full bg-white/20 backdrop-blur-sm border border-white/30 shadow-glow flex items-center justify-center animate-[float-bubble-2_13s_ease-in-out_infinite_4s]">
              <img 
            ...
            <div className="absolute bottom-20 left-1/3 w-40 h-40 rounded-full bg-white/20 backdrop-blur-sm border border-white/30 shadow-glow flex items-center justify-center animate-[float-bubble-1_16s_ease-in-out_infinite_1.5s]">
              <img 
            ...
            <div className="absolute top-20 left-1/2 w-40 h-40 rounded-full bg-white/20 backdrop-blur-sm border border-white/30 shadow-glow flex items-center justify-center animate-[float-bubble-2_12s_ease-in-out_infinite_5s]">
              <img 
