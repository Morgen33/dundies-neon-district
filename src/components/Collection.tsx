...
const Collection = () => {
  return <section id="collection" className="py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        {/* Main Card */}
        <div className="sticker-card text-center space-y-8 bg-gradient-to-br from-muted to-background/50 border-2 border-hot-pink/50 shadow-glow">
          <div className="space-y-6">
            ...
            <h2 className="text-5xl sm:text-6xl font-display font-bold">
              <span className="text-hot-pink bright-text">Own a</span>{' '}
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button className="btn-glow magnetic text-lg px-8 py-4" onClick={() => window.open('https://www.launchmynft.io/collections/8pXL1gZGWq1Y6wA7RJTmAVXcwBhzn65XdeLL7yA8AwFb/ZMZXWPY2COXyqoohzTfK', '_blank')}>
