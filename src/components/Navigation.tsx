...
const Navigation = () => {
  ...
  const renderNavLink = (link: any, isMobile = false) => {
    const baseClasses = isMobile 
      ? "block px-3 py-2 text-sm font-medium text-muted-foreground hover:text-foreground transition-colors duration-300"
      : "text-sm text-muted-foreground hover:text-foreground transition-colors duration-300 font-medium relative group";
